    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='uploader.cofkunionwork')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.CharField(max_length=100)),
                ('language_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='uploader.iso639languagecode')),
                ('manifestation_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='uploader.cofkunionmanifestation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload_name', models.CharField(max_length=254)),
                ('explicit', models.TextField()),
                ('union_iwork_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofkunionwork')),
                ('upload_id', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofkcollectupload')),
                ('upload_status', models.ForeignKey(default='1', on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofkcollectstatus')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload_name', models.CharField(max_length=254)),
                ('_id', models.CharField(max_length=32)),
                ('person_id', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofkunionperson')),
                ('upload_id', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofkcollectupload')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload_name', models.CharField(max_length=254)),
                ('_id', models.CharField(max_length=32)),
                ('union_manifestation_id', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofkunionmanifestation')),
                ('upload_id', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofkcollectupload')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.CharField(max_length=20)),
                ('longitude', models.CharField(max_length=20)),
                ('union_location_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofkunionlocation')),
                ('upload_id', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofkcollectupload')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('union_institution_id', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofkunioninstitution')),
                ('upload_id', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofkcollectupload')),
            ],
            options={
