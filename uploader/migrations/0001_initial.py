    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('union_iwork', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='union_collect_works', to='work.cofkunionwork', to_field='iwork_id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload_name', models.CharField(blank=True, max_length=254, null=True)),
                ('_id', models.CharField(blank=True, max_length=32, null=True)),
                ('union_iperson', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='union_collect_persons', to='person.cofkunionperson', to_field='iperson_id')),
                ('upload', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='uploader.cofkcollectupload')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('editors_notes', models.TextField(blank=True, null=True)),
                ('upload', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofkcollectupload')),
                ('work_id_in_tool', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofkcollectwork')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_id', models.CharField(blank=True, max_length=32, null=True)),
                ('iwork', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='uploader.cofkcollectwork')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='uploader.cofkcollectlocation')),
                ('upload', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='uploader.cofkcollectupload')),
            ],
            options={
