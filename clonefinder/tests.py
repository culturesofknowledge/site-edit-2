...
from clonefinder.features.dataset import inst_features, work_features, person_features, location_features
...
class ClusteringTestingTools:
    ...
    def test_create_clusters(self, first_cluster_ids):
        ...
        clusters = clonefinder.create_clusters(raw_df, self.create_features)
