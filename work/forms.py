...
class CompactSearchFieldset(BasicSearchFieldset):
    ...
    person_sent_pk = forms.CharField(widget=forms.HiddenInput(), required=False)
    person_rec_pk = forms.CharField(widget=forms.HiddenInput(), required=False)
    person_sent_rec_pk = forms.CharField(widget=forms.HiddenInput(), required=False)
    person_mention_pk = forms.CharField(widget=forms.HiddenInput(), required=False)
    location_sent_pk = forms.CharField(widget=forms.HiddenInput(), required=False)
    location_rec_pk = forms.CharField(widget=forms.HiddenInput(), required=False)
    location_sent_rec_pk = forms.CharField(widget=forms.HiddenInput(), required=False)
