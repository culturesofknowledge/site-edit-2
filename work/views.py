...
class WorkSearchView(LoginRequiredMixin, DefaultSearchView):
    ...
    def get_queryset(self):
        ...
        fields = [
            ...
            'notes_on_authors', 'origin_as_marked', 'addressees_searchable', 'places_from_searchable',
            'destination_as_marked', 'flags', 'images', 'manifestations_searchable', 'places_to_searchable',
