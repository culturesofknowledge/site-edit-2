    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_catalogue', models.ForeignKey(blank=True, db_column='original_catalogue', db_constraint=False, default='', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofklookupcatalogue', to_field='catalogue_code')),
            ],
            options={
