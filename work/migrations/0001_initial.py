    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_catalogue', models.ForeignKey(blank=True, db_column='original_catalogue', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='uploader.cofklookupcatalogue')),
            ],
            options={
