    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iwork_id', models.IntegerField(default=functools.partial(core.helper.model_utils.next_seq_safe, *('cofk_union_person_iwork_id_seq',), **{}), unique=True)),
                ('editors_notes', models.TextField(blank=True, null=True)),
                ('edit_status', models.CharField(default='', max_length=3)),
                ('relevant_to_cofk', models.CharField(default='Y', max_length=3)),
                ('creation_timestamp', models.DateTimeField(blank=True, default=model_utils.default_current_timestamp, null=True)),
                ('creation_user', models.CharField(max_length=50)),
                ('change_timestamp', models.DateTimeField(blank=True, default=model_utils.default_current_timestamp, null=True)),
                ('change_user', models.CharField(max_length=50)),
                ('uuid', models.UUIDField(blank=True, default=model_utils.default_uuid, null=True)),
