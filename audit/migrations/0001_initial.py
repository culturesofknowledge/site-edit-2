# Generated by Django 4.0.6 on 2022-12-01 13:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('change_user', models.CharField(max_length=50, null=True)),
                ('change_type', models.CharField(max_length=3, null=True)),
                ('table_name', models.CharField(max_length=100, null=True)),
                ('key_value_text', models.CharField(max_length=100, null=True)),
