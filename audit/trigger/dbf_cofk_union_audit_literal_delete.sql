create function dbf_cofk_union_audit_literal_delete(input_table_name character varying, input_key_value_text character varying, input_key_value_integer integer, input_key_decode text, input_column_name character varying, input_old_column_value text) returns void
    language plpgsql
as
$$
...
alter function dbf_cofk_union_audit_literal_delete(varchar, varchar, integer, text, varchar, text) owner to postgres;
