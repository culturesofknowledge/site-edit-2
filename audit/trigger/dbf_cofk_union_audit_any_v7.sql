...
-------------------
  ...
  if TG_RELNAME = 'cofk_union_institution' then
    ...
    -- cofk_union_institution 8. editors_notes
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_institution',
        new.institution_id::text,
        new.institution_id,
...
-------------------
  ...
  if TG_RELNAME = 'cofk_union_manifestation' then
    ...
    -- cofk_union_manifestation 21a. manifestation_creation_date_is_range
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
        ...
        new.manifestation_creation_date_is_range::text,
        old.manifestation_creation_date_is_range::text );
    end if;
    ...
    -- cofk_union_manifestation 21b. manifestation_creation_date2_year
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
        ...
        new.manifestation_creation_date2_year::text,
        old.manifestation_creation_date2_year::text );
    end if;
    ...
    -- cofk_union_manifestation 21c. manifestation_creation_date2_month
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
        ...
        new.manifestation_creation_date2_month::text,
        old.manifestation_creation_date2_month::text );
    end if;
    ...
    -- cofk_union_manifestation 21d. manifestation_creation_date2_day
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
        ...
        new.manifestation_creation_date2_day::text,
        old.manifestation_creation_date2_day::text );
    end if;
    ...
    -- cofk_union_manifestation 28. opened
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
    ...
    -- cofk_union_manifestation 29. stored_folded
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
        coalesce( new.id_number_or_shelfmark, '' ) || coalesce( new.printed_edition_details, '' ),
        'stored_folded',
        new.stored_folded::text,
        old.stored_folded::text );
    end if;
    ...
    -- cofk_union_manifestation 30. postage_costs_as_marked
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
        ...
        new.postage_costs_as_marked::text,
        old.postage_costs_as_marked::text );
    end if;
    ...
    -- cofk_union_manifestation 31. postage_costs
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
        coalesce( new.id_number_or_shelfmark, '' ) || coalesce( new.printed_edition_details, '' ),
        'postage_costs',
        new.postage_costs::text,
        old.postage_costs::text );
    end if;
    ...
    -- cofk_union_manifestation 32. routing_mark_stamp
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
        coalesce( new.id_number_or_shelfmark, '' ) || coalesce( new.printed_edition_details, '' ),
        'routing_mark_stamp',
        new.routing_mark_stamp::text,
        old.routing_mark_stamp::text );
    end if;
    ...
    -- cofk_union_manifestation 33. routing_mark_ms
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
        coalesce( new.id_number_or_shelfmark, '' ) || coalesce( new.printed_edition_details, '' ),
        'routing_mark_ms',
        new.routing_mark_ms::text,
        old.routing_mark_ms::text );
    end if;
    ...
    -- cofk_union_manifestation 34. handling_instructions
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
        ...
        new.handling_instructions::text,
        old.handling_instructions::text );
    end if;
    ...
    -- cofk_union_manifestation 35. non_delivery_reason
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
    ...
    -- cofk_union_manifestation 45a. manifestation_receipt_date_is_range
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
        ...
        new.manifestation_receipt_date_is_range::text,
        old.manifestation_receipt_date_is_range::text );
    end if;
    ...
    -- cofk_union_manifestation 45b. manifestation_receipt_date2_year
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
        ...
        new.manifestation_receipt_date2_year::text,
        old.manifestation_receipt_date2_year::text );
    end if;
    ...
    -- cofk_union_manifestation 45c. manifestation_receipt_date2_month
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
        ...
        new.manifestation_receipt_date2_month::text,
        old.manifestation_receipt_date2_month::text );
    end if;
    ...
    -- cofk_union_manifestation 45d. manifestation_receipt_date2_day
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_manifestation',
        new.manifestation_id,
        null,
        ...
        new.manifestation_receipt_date2_day::text,
        old.manifestation_receipt_date2_day::text );
    end if;
  ...
  if TG_RELNAME = 'cofk_union_person' then
    ...
    if TG_OP = 'UPDATE' then
      perform dbf_cofk_union_audit_literal_update( 'cofk_union_person',
        ...
        new.foaf_name,
        'is_organisation',
        new.is_organisation::text,
        old.is_organisation::text );
    end if;
