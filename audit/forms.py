...
changed_field_choices = [
    ...
    ('date_of_work_std_day', 'Date of Work - Day (beginning of range or single date)'),
    ('date_of_work_std_month', 'Date of Work - Month (beginning of range or single date)'),
    ('date_of_work_std_year', 'Date of Work - Year (beginning of range or single date)'),
    ('date_of_work2_std_day', 'Date of Work - Day (end of range)'),
    ('date_of_work2_std_month', 'Date of Work - Month (end of range)'),
    ('date_of_work2_std_year', 'Date of Work - Year (end of range)'),
    ...
    ('from_date', 'Relationship valid from'),
    ...
    ('is_organisation', 'Is Organization'),
    ('keywords', 'Keywords'),
    ...
    ('manifestation_creation_date2_day', 'Manifestation Creation Date - Day (end of range)'),
    ('manifestation_creation_date2_month', 'Manifestation Creation Date - Month (end of range)'),
    ('manifestation_creation_date2_year', 'Manifestation Creation Date - Year (end of range)'),
    ...
    ('manifestation_creation_date_day', 'Manifestation Creation Date - Day (beginning of range or single date)'),
    ...
    ('manifestation_creation_date_month', 'Manifestation Creation Date - Month (beginning of range or single date)'),
    ('manifestation_creation_date_uncertain', 'Manifestation Creation Date Uncertain'),
    ('manifestation_creation_date_year', 'Manifestation Creation Date - Year (beginning of range or single date)'),
    ...
    ('manifestation_receipt_date2_day', 'Manifestation Receipt Date - Day (end of range)'),
    ('manifestation_receipt_date2_month', 'Manifestation Receipt Date - Month (end of range)'),
    ('manifestation_receipt_date2_year', 'Manifestation Receipt Date - Year (end of range)'),
    ('manifestation_receipt_date_approx', 'Manifestation Receipt Date Approx'),
    ('manifestation_receipt_date_day', 'Manifestation Receipt Date - Day (beginning of range or single date)'),
    ...
    ('manifestation_receipt_date_month', 'Manifestation Receipt Date - Month (beginning of range or single date)'),
    ('manifestation_receipt_date_uncertain', 'Manifestation Receipt Date Uncertain'),
    ('manifestation_receipt_date_year', 'Manifestation Receipt Date - Year (beginning of range or single date)'),
    ...
    ('person_aliases', 'Roles/Titles'),
    ('iperson_id', 'Person ID'),
    ('person_id', 'Person ID (for internal system use)'),
    ('foaf_name', 'Person or organization name'),
    ...
    ('thumbnail', 'Thumbnail'),
    ('to_date', 'Relationship valid till'),
    ('uuid', 'Uuid'),
    ('iwork_id', 'Work ID'),
